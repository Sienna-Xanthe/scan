defmodule Scan.Mailer do
  ...
  @logo_url "https://i.328888.xyz/2023/04/11/ip8EDP.png"

  @spec html_template(any) :: <<_::64, _::_*8>>
          ...
          <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td style="background-color: #333333; padding: 30px;">
                <center><img src="#{@logo_url}" alt="Scan" width="116" height="45" align="center" /></center>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="background-color: #eef1f3; font-family:sans-serif; font-size: 16px; padding: 20px 30px;">
                <center>
                  <a style="color: #888888; font-family: sans-serif; font-size: 16px;" href="https://localhost:4000">Log in to Scan</a>
                </center>
              </td>
            </tr>
          </table>
